...
public class PredictionService {
    ...
    private final ComputeGateway computeGateway;
    private final StorageService storageService;

    public PredictionService(ComputeGateway computeGateway, StorageService storageService) {
    ...
    public List<Prediction> prediction(HttpServletRequest httpServletRequest, @RequestBody String body) throws IOException {
        ...
        List<Prediction> predictions = computeGateway.callPredictionHttpClient(input);
